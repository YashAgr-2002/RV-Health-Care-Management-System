...
<!-- <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" > -->
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><img src="img/rvlogo.png" style="border-radius:25px 25px" alt="Logo" width="50px" height="50px">&nbsp RV HEALTH CENTER &nbsp<img src="img/healthlogo.png" alt="Logo" width="50px" height="50px"></h4></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="chatbot_index.php" style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6>CHATBOT</h6></a>
          </li>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%;">
                        <img src="images/rvce_logo.png" style="height:150px; width:200px;" alt=""/>
                        <h3>Welcome</h3>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">                                    
                                            <input type="date" class="form-control" min="1995-05-11" max="2020-05-20" placeholder="Date of Birth *" name="dateofbirth" required/>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="tel"  maxlength="10" name="contact" class="form-control" placeholder="Phone num format([6-9][0-9]{9})"  required pattern="[6-9][0-9]{9}"/>
                                        </div>
                                        <div class="form-group">
