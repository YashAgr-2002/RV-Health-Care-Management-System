...
if(isset($_POST['patsub1'])){
  ...
  if($password==$cpassword){
  	$query="insert into patreg(fname,lname,usn,gender,dob,email,contact,password,cpassword) values ('$fname','$lname','$usn','$gender','$dob','$email','$contact','$password','$cpassword');";
