    ...
    if((date("Y-m-d",$appdate1)==$cur_date and date("H:i:s",$apptime1)>$cur_time) or date("Y-m-d",$appdate1)>$cur_date) {
      $check_query = mysqli_query($con,"select apptime from appointmenttb where doctor='$doctor' and appdate='$appdate' and apptime='$apptime'");
        ...
        if(mysqli_num_rows($check_query)==0){
          $query=mysqli_query($con,"insert into appointmenttb(pid,fname,lname,usn,gender,dob,email,contact,doctor,appdate,apptime,userStatus,doctorStatus) values($pid,'$fname','$lname','$usn','$gender','$dob','$email','$contact','$doctor','$appdate','$apptime','1','1')");
...
if(isset($_GET['cancel']))
  ...
  function generate_prescription(){
    ...
    $pid = $_SESSION['pid'];
    $output='';
    $query=mysqli_query($con,"select p.pid,p.ID,a.usn,p.fname,p.lname,p.doctor,p.appdate,p.apptime,p.disease,p.allergy,p.vaccine,p.prescription from prestb p inner join appointmenttb a on p.ID=a.ID and p.pid = '$pid' and p.ID = '".$_GET['ID']."'");
    if($row = mysqli_fetch_array($query)){
      ...
      <label> Vaccine : </label>'.$row["vaccine"].'<br/><br/>
  ...
  if(isset($_GET["generate_prescription"])){
    require_once("TCPDF/tcpdf.php");
    $obj_pdf = new TCPDF('P',PDF_UNIT,PDF_PAGE_FORMAT,true,'UTF-8',false);
    $obj_pdf -> SetCreator(PDF_CREATOR);
    $obj_pdf -> SetTitle("Generate Prescription");
    ...
    $content .= '
        ...
        <h2 align ="center"> <img src="img/rvlogo.jpg" alt="Logo" width="50px" height="50px">RV Health Center <img src="img/healthlogo.jpg"  alt="Logo" width="50px" height="50px"></h2>      
        <p align ="center">Mysore Road, Bengaluru - 560 059.</p>
        <p align ="center">E-mail : rvcehealthcenter@rvce.edu.in</p>
        <p align ="center"> Ph : 080-68188102</p>
        <hr/>
  ...
  <html lang="en">
    ...
    <a class="navbar-brand" href="#"><img src="img/rvlogo.png" style="border-radius:25px 25px" alt="Logo" width="50px" height="50px">&nbsp RV HEALTH CENTER &nbsp<img src="img/healthlogo.png" alt="Logo" width="50px" height="50px"> </a>
              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Prescription Print</th>
                  </tr>
                </thead>
                <tbody>
                  <?php 
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <!-- <a href="admin-panel.php?ID=" 
                              ...
                              <input type = "submit" onclick="alert('Prescription Generated Successfully');" name ="generate_prescription" class = "btn btn-success" value="Print"/>
                              </a>
                              </td>
                              </form>
